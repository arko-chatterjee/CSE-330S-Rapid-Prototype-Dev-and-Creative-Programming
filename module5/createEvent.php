<?php
    ...
    $stmt = $mysqli->prepare("INSERT into events (user_id, title, multi, date, start, end, location, description, tags) values (?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param('issssssss',$userid,$title,$multi,$startDate,$begin,$end,$location,$desc,$tags);
